import { BtnSpan, Container, GoLinkBtn, HeroText, HeroTitle, HeroWrapper } from './Home.styled';
      ...
      <div>
        ...
        <HeroText>
          ...
          communication, more positivity, more tweets...
              ...
              <GoLinkBtn to='/tweets'><BtnSpan>Go tweets</BtnSpan><BsArrowRight size={22}/></GoLinkBtn>
      </HeroWrapper>
    </Container>
  );
};
